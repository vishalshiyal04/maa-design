...
//   return (
//     // Adjusted top padding (pt-12) so the map sits closer to the section above it
//     <section id="contact" className="pt-12 pb-20 px-6 bg-[#0a1930] text-white relative">
//       <div className="max-w-7xl mx-auto">

//         {/* 1. MAP SECTION (Moved to the very top!) */}
//         <div className="w-full h-[350px] md:h-[450px] bg-white/5 rounded-3xl overflow-hidden shadow-2xl border-[4px] border-white/10 mb-20 relative z-20">
//           <iframe 
  ...
  return (
    <section id="contact" className="pt-12 pb-20 px-6 bg-[#0a1930] text-white relative">
      <div className="max-w-7xl mx-auto">
        ...
        {/* MAP SECTION */}
        <div className="w-full h-[350px] md:h-[450px] bg-white/5 rounded-3xl overflow-hidden shadow-2xl border-[4px] border-white/10 mb-20 relative z-20 transition-transform duration-700 hover:scale-[1.01]">
          <iframe 
            title="Maa Embroidery Location"
            src={embedUrl} 
            width="100%" 
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          {/* LEFT SIDE: Contact Info Cards */}
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-white/5 p-8 rounded-2xl border border-white/10 hover:border-white/40 transition-all duration-300 flex items-start gap-4 shadow-sm backdrop-blur-sm hover:-translate-y-1 hover:shadow-xl hover:shadow-blue-500/10">
              <div className="bg-white p-4 rounded-full text-[#0a1930] text-2xl shadow-lg">
                <FaMapMarkerAlt />
              </div>
              <div>
          ...
          <div className="lg:col-span-2 bg-white p-8 md:p-12 rounded-3xl border border-white/10 shadow-2xl relative overflow-hidden">
            ...
            {status === 'success' ? (
              <div className="absolute inset-0 bg-white/95 backdrop-blur-sm flex flex-col items-center justify-center z-30 transition-all duration-500 animate-in fade-in zoom-in-95">
                ...
                <h3 className="text-3xl font-extrabold text-[#0a1930] mb-2">Message Sent!</h3>
